...
public class SimpleResourceDefinitionTest {
  ...
  public void testDirectives() {
    ...
    directives.put(BaseResourceDefinition.DirectiveType.CREATE, Arrays.asList("refresh_cache_on_exception", "POST1", "POST2"));
    directives.put(BaseResourceDefinition.DirectiveType.READ, Arrays.asList("refresh_cache_on_exception", "GET1", "GET2"));
    directives.put(BaseResourceDefinition.DirectiveType.UPDATE, Arrays.asList("refresh_cache_on_exception", "PUT1", "PUT2"));
    directives.put(BaseResourceDefinition.DirectiveType.DELETE, Arrays.asList("refresh_cache_on_exception", "DEL1", "DEL2"));
